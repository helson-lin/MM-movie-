...
const changePlay = (val: PlayItem) => (activeItem.value = val);
const cc = (obj: Movie) => {
...
const src = computed(() => {
  ...
  if (isM3u8) {
    return baseUrl + activeItem.value.url;
  } else {
    ...
    <div class="box flex-row">
     <div class="inner-player">
      ...
      <div class="url-list flex-row">
        <div class="url" v-for="item in list" :key="item.name">
          <div
